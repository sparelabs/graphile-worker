 ...
 * for watch mode).
 */
function fauxRequire(spec, cache = {}) {
    ...
    const contents = (0, fs_1.readFileSync)(filename, "utf8");
     ...
     */
    // @ts-ignore
    replacementModule.paths = Module._nodeModulePaths((0, path_1.dirname)(filename));
