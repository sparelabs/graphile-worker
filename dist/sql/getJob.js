...
exports.getJob = exports.isPromise = void 0;
const taskIdentifiers_1 = require("../taskIdentifiers");
...
with j as (
  ...
  update ${escapedWorkerSchema}.jobs
    ...
    const { rows: [jobRow], } = await withPgClient((client) => client.query({
        text,
        values,
        name,
    }));
